...
description: "Tallinna Ülikooli mehaanika praktikumi kursuse \"Pöördliikumise põhivõrrandi katselise kinnitamise Oberbecki pendli abil\" praktilise ülesande peacecop kalmeri: raport."
lang: et
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'LABORATOORNE TÖÖ 6<br/>Pöördliikumise põhivõrrandi katseline kinnitamine<br/>Oberbecki pendli abil' }`"
...
1. Jäiga keha dünaamika põhivõrrandi kehtivus uuritud.

2. Hooratta inertsimomendi määramise võimalus langeva raskuse abil, tundma õpitud.
